...
<html>
    ...
    <body>     
        ...
        <span class="d-block p-2 bg-primary text-white text-center"  >Blog Preview</span>


<div class="d-flex justify-content-center mt-5">
        <a href="#bottom" class="p-2 bg-primary text-white rounded text-center" >Check Oldest Blog &darr; </a>
</div>
<br><br>
        <!--        SHOW  BLOG  PREVIEW-->
